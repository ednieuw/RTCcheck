...
void PrintRTCtimes(void)
{
  for (int i = 0; i < MAX_RTC; i++)                                                           // Read time of all ACTIVE RTC modules
  {
    ...
    delay(10);
    char ff[16];
    dtostrf(rtc[i].getTemperature(), 0, 2, ff);                                               // Get the RTC temperature
 ...
 for (int i = 0; i < MAX_RTC; i++)                                                           // Read time of all ACTIVE RTC modules
  {
   ...
   switch (c)
    ...
    // {
    //   case  0 ...  1: ColorLed(i,green);     Tekstprint("|green ");      break;
    //   case  2 ...  4: ColorLed(i,orange);    Tekstprint("|orange ");     break;
    //   case  5 ...  7: ColorLed(i,greenblue); Tekstprint("|greenblue ");  break;
    //   case  8 ... 10: ColorLed(i,darkviolet);Tekstprint("|darkviolet "); break;
    //   case 11 ... 17: ColorLed(i,pink);      Tekstprint("|pink ");       break;
    //   case 18 ... 25: ColorLed(i,purple);    Tekstprint("|purple ");     break;
    //   case 26 ...999: ColorLed(i,red);       Tekstprint("|red ");        break;
    //   default:        ColorLed(i,blue);      Tekstprint("|blue ");
    // }
  }
ShowLeds(); 
}
