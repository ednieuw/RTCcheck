...
{   
 ...
 DimLeds(Mem.TimeMinute == 1);                                                                // and DimLEDs are used to print the time every minute
...
void EveryHourUpdate(void)
{
 ...
 SumLDRreadshour  = 0;
 NoofLDRreadshour = 0;
 DimLeds(Mem.TimeMinute==2);                                                                    // and DimLEDs are used to print the time every hour 
