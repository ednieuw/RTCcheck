 ...
 for (int i = 0; i < MAX_RTC; i++)                                  // Read time of all ACTIVE RTC modules
  {
   ...
   switch (c)
    {
      case  0:        ColorLed(i,green);        break;
      case  1 ...  2: ColorLed(i,orange);       break;
      case  3 ...  4: ColorLed(i,grass);        break;
      case  5 ...  6: ColorLed(i,marine);       break;
      case  7 ... 10: ColorLed(i,darkviolet);   break;
